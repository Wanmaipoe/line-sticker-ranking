...
const DESC_TH =
  'ดูอันดับสติกเกอร์ไลน์ขายดี ครบ 500 อันดับ อัปเดตทุกชั่วโมงจาก LINE Store เช็คอันดับสติกเกอร์ของตัวเองได้ฟรี พร้อมกราฟย้อนหลัง 30 วัน ทั้งไทย ญี่ปุ่น ไต้หวัน';
...
const FEATURES = [
  ...
  {
    icon: '🌏',
    title: '3 ประเทศในที่เดียว',
    body: 'เทียบอันดับข้ามประเทศได้ทันที ไทย ญี่ปุ่น และไต้หวัน',
  },
  {
    icon: '🏅',
